...
const PaymentForm = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-gradient-to-r from-indigo-600 to-purple-700 p-6"
        style={{
      ...
      >
        <h2
          className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-purple-500 hover:to-pink-500 bg-clip-text text-transparent text-lg md:text-2xl pt-10px"
          style={{
            fontSize: "18px", 
          }}
        >
      ...
      <form onSubmit={handlePayment} className="p-4 space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            >
              <option value="credit_card" className="bg-gray-800">
                Credit Card
              </option>
              <option value="debit_card" className="bg-gray-800">
                Debit Card
              </option>
            </select>
        ...
        <div
          className="bg-gray-700 p-3 rounded-lg mb-6"
          style={{
            marginTop: "10px",
            marginBottom: "10px",
          }}
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-blue-900/30"
          style={{
