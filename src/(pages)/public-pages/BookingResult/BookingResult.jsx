  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="bg-gradient-to-r from-blue-900 to-purple-900 p-6 border-b border-gray-700"
          style={{
            textAlign: "center", 
            borderRadius: "5rem",
            alignItems: "center",
        ...
        <div className="p-6 border-b border-gray-700">
          <h2
            className="text-xl font-semibold mb-4 text-blue-400 flex items-center justify-center"
            style={{
        ...
        <div className="p-6 border-b border-gray-700">
          ...
          <div className="space-y-4">
            {selectedBooking?.travelers?.map((traveler, index) => (
              <div
                key={index}
                className="bg-gray-750 rounded-lg p-4 border border-gray-700 hover:border-blue-500 transition-colors duration-300"
              >
                <div className="flex flex-col justify-between">
                  <div>
                    <p className="text-gray-400 text-[13px]">FullName**</p>
                    <p className="font-medium text-lg text-white pb-10">{traveler.firstName} {traveler.lastName}</p>
                    <p className="text-gray-400 text-[13px]">Email Address**</p>
                    <p className="text-gray-300 mt-1">{traveler.email}</p>
                  </div>
                  <div className="mt-3">
                    <span
                    ...
                    <span
                      className="px-3 py-1 bg-purple-900 text-purple-200 rounded-full text-sm ml-2"
                      style={{
                        paddingLeft: "10px",
                        paddingRight: "10px",
                      }}
                ...
                <div className="mt-3 pt-3 border-t border-gray-700">
                  ...
                  <p className="text-gray-400">
                    Passport: <span className="text-gray-300">{traveler.passportNumber}</span>
                  </p>
                </div>
              </div>
            ))}
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-750 rounded-lg p-4 border border-gray-700">
            <div className="flex flex-col justify-between items-start">
              ...
              <button
                className="mt-4 w-full bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-blue-900/30"
        ...
        <div
          className="bg-gray-850 p-4 text-center text-gray-400 text-sm"
          style={{
            marginTop: "20px",
          }}
        >
