...
const PaymentResult = () => {
  ...
  return (
<div
  className="payment-result-container font-Josefin text-gray-200 max-w-4xl mx-auto px-4 py-8"
  style={{
    width: "100%", 
    maxWidth: "700px", 
    margin: "0 auto",
...
>
  ...
  <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
    ...
    <div
      className="bg-gray-900 bg-opacity-70 border border-gray-800 rounded-lg p-6 shadow-lg"
      style={{
        paddingTop: "20px",
        paddingBottom: "20px",
        paddingLeft: "15px",
      ...
      <div className="booking-summary mb-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="flex flex-col space-y-1">
            ...
            <span className="text-lg font-mono">{bookingReference || "N/A"}</span>
          </div>
          <div className="flex flex-col space-y-1">
          ...
          <div className="flex flex-col space-y-1">
            ...
            <span className="text-xl font-bold text-white">
              {price.currency ? `${price.currency} ${price.total || 0}` : "N/A"}
            </span>
          </div>
          <div className="flex flex-col space-y-1">
        ...
        {payment ? (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-col space-y-1">
              <span className="text-gray-400 text-sm">Status</span>
              <span
                className={`font-semibold ${getStatusColor(payment.status)}`}
              >
                {payment.status}
              </span>
            </div>
        ...
        <div className="traveler-details">
          ...
          {traveler ? (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="flex flex-col space-y-1">
                <span className="text-gray-400 text-sm">Passport Number</span>
            ...
            <p className="text-gray-400">No traveler information available.</p>
          )}
        </div>
      </div>
      ...
      >
        ...
        {user ? (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-col space-y-1">
              <span className="text-gray-400 text-sm">Travel Frequency</span>
            ...
            <div className="flex flex-col space-y-1">
              ...
              <div className="flex gap-2">
                ...
                <span>•</span>
                <span
                  className={user.isVerified ? "text-green-400" : "text-yellow-400"}
                >
  ...
  <div
    className="bg-gray-900 bg-opacity-70 border border-gray-800 rounded-lg p-6 shadow-lg mt-6"
    style={{
      paddingTop: "20px",
      paddingBottom: "20px",
      paddingLeft: "15px",
  ...
  >
    <button
      className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 w-full md:w-auto"
      style={{
        padding: "0.5rem 1rem",
        borderRadius: "0.5rem",
        border: "none",
