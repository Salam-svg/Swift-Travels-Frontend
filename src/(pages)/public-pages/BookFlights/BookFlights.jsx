...
const FlightBookingForm = () => {
  ...
  return (
    <div className="min-h-screen font-Josefin flex items-center justify-center p-4group rounded-2xl overflow-hidden">
      <div
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-between items-center">
            <button
              type="button"
              onClick={addTraveler}
              className="flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition duration-300 ease-in-out transform hover:scale-105"
            >
